...
/**
 * Created by Dmitry Kuzmin on 12.11.2015.
 */
public class EpsonFiscalPacket extends AbstractFiscalPacket {
  ...
  public EpsonFiscalPacket(String encoding, int baseRolloverYear) {
  ...
  public void setDate(int field, int year, int month, int day) {
    if (year < baseRolloverYear || year >= baseRolloverYear + 100 || month < 1 || month > 12 || day < 1 || day > 31)

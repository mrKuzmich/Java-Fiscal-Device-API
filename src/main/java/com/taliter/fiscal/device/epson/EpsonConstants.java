...
public interface EpsonConstants
{
	...
	// EXTENDS COMMANDS
	public int CMD_STATUS_REQUEST_EXT         = 0x0001;
	public int CMD_GET_INFORMATION_EXT        = 0x020A;

	public int CMD_DAILY_CLOSE_EXT            = 0x0801;
	...
	public int CMD_SUBTOTAL_EXT               = 0x0A03;
	public int CMD_GENERAL_DISCOUNT_EXT       = 0x0A04;
	public int CMD_TOTAL_TENDER_EXT           = 0x0A05;
	public int CMD_CLOSE_FD_EXT               = 0x0A06;
	public int CMD_CANCEL_DOCUMENT_EXT        = 0x0A07;
	public int CMD_SALES_INFO                 = 0x0A0D;

	public int CMD_OPEN_TF                    = 0x0B01;
	public int CMD_PRINT_LINE_ITEM_TF         = 0x0B02;
	public int CMD_SUBTOTAL_TF                = 0x0B03;
	public int CMD_GENERAL_DISCOUNT_TF        = 0x0B04;
	public int CMD_TOTAL_TENDER_TF            = 0x0B05;
	public int CMD_CLOSE_TF                   = 0x0B06;
	public int CMD_CANCEL_DOCUMENT_TF         = 0x0B07;

	public int CMD_OPEN_NFD_TICKET_EXT        = 0x0E01;
	public int CMD_PRINT_NON_FISCAL_TEXT_EXT  = 0x0E02;
	public int CMD_CLOSE_NFD_EXT              = 0x0E06;
